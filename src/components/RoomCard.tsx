import { MapPin, DollarSign, Users, Home, Star, CheckCircle, GraduationCap, Heart, Eye } from 'lucide-react';
...
export function RoomCard({ room, onClick }: RoomCardProps) {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer group border border-teal-100 relative"
      style={{
    ...
    >
      <div className="relative h-56 bg-gray-200 overflow-hidden">
        ...
        {/* Top Left Section - Favorite & Viewed */}
        ...
        {/* Top Right Section - Price & Available Spots */}
        <div className="absolute top-3 right-3 flex flex-col gap-2 items-end">
          {/* Price Tag */}
          <div className="bg-gradient-to-r from-teal-600 to-emerald-600 text-white px-3 py-1.5 rounded-full shadow-lg backdrop-blur-sm">
          ...
          {room.availableSpots > 0 && (
            <div className="bg-gradient-to-r from-amber-500 to-orange-500 text-white px-2.5 py-1 rounded-full shadow-lg text-xs whitespace-nowrap">
              🏠 Còn {room.availableSpots} chỗ
            </div>
          )}
        </div>
      ...
      <div className="p-4">
        ...
        {room.tenants.length > 0 && (
          <div className="pt-3 border-t border-gray-100">
            <p className="text-xs text-gray-500 mb-2">Người đang ở:</p>
